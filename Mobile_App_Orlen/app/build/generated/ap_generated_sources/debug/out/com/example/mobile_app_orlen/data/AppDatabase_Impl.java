...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `measurements` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `userId` TEXT, `coValue` REAL NOT NULL, `so2Value` REAL NOT NULL, `ch4Value` REAL NOT NULL, `timestamp` INTEGER NOT NULL, `isAnomaly` INTEGER NOT NULL, `notes` TEXT, `latitude` REAL NOT NULL, `longitude` REAL NOT NULL, `locationName` TEXT)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '7ee1608036100ee04184d8cee0284384')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoMeasurements.equals(_existingMeasurements)) {
          return new RoomOpenHelper.ValidationResult(false, "measurements(com.example.mobile_app_orlen.data.Measurement).\n"
                  + " Expected:\n" + _infoMeasurements + "\n"
                  + " Found:\n" + _existingMeasurements);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "7ee1608036100ee04184d8cee0284384", "fcc88cfb423366680dc25b044efcd6fb");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "measurements");
  }
